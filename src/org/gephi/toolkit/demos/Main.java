...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * rankingGraph.script();
		 * 
		 * Filtering filtering = new Filtering(); filtering.script();
		 * 
		 ...
		 * 
		 * ManualGraph manualGraph = new ManualGraph(); manualGraph.script();
		 * 
		 * ManipulateAttributes manipulateAttributes = new
		 * ManipulateAttributes(); manipulateAttributes.script();
		 * 
