 ...
 * <ul>
 * <li>Rank node colors by degree</li>
	...
	public void script() {
		...
		try {
			File file = new File(getClass().getResource(
					"/org/gephi/toolkit/demos/resources/lesmiserables.gml")
					.toURI());
		...
		Ranking centralityRanking2 = rankingController.getModel().getRanking(
				Ranking.NODE_ELEMENT, centralityColumn.getId());
		...
		// Set 'show labels' option in Preview - and disable node size influence
		// on text size
		PreviewModel previewModel = Lookup.getDefault()
