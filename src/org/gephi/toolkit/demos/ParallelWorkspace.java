 ...
 * <ul>
 * <li>How to duplicate a workspace.</li>
 ...
 * required to set current workspace, as showed in export here.</li>
 * </ul>
 * <p>
...
public class ParallelWorkspace {
	...
	private Runnable createLayoutRunnable(final Workspace workspace) {
		return new Runnable() {
			...
			public void run() {
				GraphModel gm = Lookup.getDefault()
				...
				autoLayout.addLayout(new YifanHuLayout(null,
						new StepDisplacement(1f)), 1f);
				autoLayout.execute();
			}
		};
	}
